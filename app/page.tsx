...
export default function CVForge(){
  ...
  const handleFile=async file=>{
    ...
    if(isPDF){const reader=new FileReader();reader.onload=e=>setRefFile({name:file.name,data:e.target.result.split(",")[1],type:"pdf",text:""});reader.readAsDataURL(file);}
    else{const reader=new FileReader();reader.onload=e=>setRefFile({name:file.name,data:null,type:"text",text:e.target.result});reader.readAsText(file);}
  };
